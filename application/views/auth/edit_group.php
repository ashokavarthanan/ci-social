			...
			<div class="card-body bg-white">
				...
				<div class="form-group">
					<?php $group_name['class'] = 'form-control';
								echo lang('edit_group_name_label', 'group_name');
								echo form_input($group_name);?>
				</div>

				<div class="form-group">
					<?php $group_description['class'] = 'form-control';
								echo lang('edit_group_desc_label', 'description');
								echo form_input($group_description);?>
				</div>

				<div class="form-group mb-0">
					<?php echo form_submit('submit', lang('edit_group_submit_btn'), 'class="btn btn-block btn-md btn-primary"');?>       
				</div>
